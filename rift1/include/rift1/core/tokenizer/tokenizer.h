...
// OBINexus AEGIS Framework - Stage 0→1 pipeline coordination with dual-mode parser support
 ...
 * @param config AEGIS configuration including pipeline, parser, and validation settings
...
/**
 * @brief Detects parser mode from input using regex pattern R"/[^A-Z0-9\b]/gmi[t|b]"
 * @param orchestrator Initialized orchestrator
 ...
 */
RiftParserModeDetection rift_tokenizer_detect_parser_mode(
 ...
 */
RiftParserModeDetection rift_tokenizer_get_parser_mode(
    const RiftTokenizerOrchestrator* orchestrator);
 ...
 */
RiftMemoryToken** rift_tokenizer_get_tokens_by_type(
    const RiftTokenizerOrchestrator* orchestrator,
    RiftTokenType type,
    size_t* result_count);
 ...
 */
double rift_tokenizer_get_enhancement_rate(const RiftTokenizerOrchestrator* orchestrator);
 ...
 */
RiftTokenizerMetrics rift_tokenizer_get_metrics(const RiftTokenizerOrchestrator* orchestrator);
 ...
 */
const char* rift_tokenizer_get_last_error(const RiftTokenizerOrchestrator* orchestrator);
 ...
 */
bool rift_tokenizer_establish_quantum_coherence(RiftTokenizerOrchestrator* orchestrator);
 ...
 */
bool rift_tokenizer_collapse_quantum_states(RiftTokenizerOrchestrator* orchestrator);
