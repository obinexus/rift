...
bool rift_file_save_rift0(const char* filename, 
                         RiftLexeme** lexemes, 
                         size_t lexeme_count,
                         RiftFileMode mode);
bool rift_file_load_rift0(const char* filename, 
                         RiftLexeme*** lexemes, 
                         size_t* lexeme_count,
                         RiftFileMode* mode);

bool rift_file_save_rift1(const char* filename, 
                         RiftMemoryToken** tokens, 
                         size_t token_count,
                         RiftFileMode mode);
bool rift_file_load_rift1(const char* filename, 
                         RiftMemoryToken*** tokens, 
                         size_t* token_count,
                         RiftFileMode* mode);
